...
CONSOLIDATED_FILE = os.path.join(
    BASE_OUTPUT_FOLDER,
    "FTHC_daily_history_missing_12.csv"
)

AUDIT_FILE = os.path.join(
    BASE_OUTPUT_FOLDER,
    "FTHC_daily_history_missing_12_audit.csv"
)

os.makedirs(BASE_OUTPUT_FOLDER, exist_ok=True)
os.makedirs(INDIVIDUAL_FOLDER, exist_ok=True)

# Massive free-tier pacing.
...
if "symbol" not in symbols_df.columns:
    raise RuntimeError(
        "fthc_missing_12_symbols.csv must contain a column named 'symbol'."
    )
...
print()
print("=" * 75)
print("FTHC MISSING-12 DAILY-HISTORY DOWNLOAD")
print("=" * 75)
...
if len(symbols) != 12:
    print(
        f"WARNING: Expected 12 symbols but loaded {len(symbols)}."
    )
...
if not failures.empty:
    ...
    print()
    print("ALL 12 SYMBOLS DOWNLOADED SUCCESSFULLY.")