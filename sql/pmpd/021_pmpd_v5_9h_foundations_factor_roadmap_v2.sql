...
-- Migration 021 — PMPD V5 9H Foundations / Factor Roadmap V2
...
select
    ...
    f.priority, f.status, f.timing_type, f.data_type, f.data_available,
...
begin
    ...
    where strategy_id=v_strategy_id and factor_code like 'V5%';
    if v_native < 48 then
        raise exception 'Migration 021: expected at least 48 V5-native factors, found %.',v_native;
    end if;
