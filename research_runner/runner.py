...
JOBS = [
    ...
    {"id": "IR11-P3-B1", "project": "ir11", "module": "research_runner.jobs.ir11_p3_normalization_b1", "description": "IR-11 P3 Batch 1 broad pre-specified normalization comparison"},\n    {"id": "IR11-P3-B2", "project": "ir11", "module": "research_runner.jobs.ir11_p3_normalization_b2", "description": "IR-11 P3 Batch 2 prior-60 normalization across primary first-passage matrices"},
]
